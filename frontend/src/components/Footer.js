      ...
      <div className="bg-[#f1f5f9] h-[38rem] w-full flex flex-col mini:flex-row mini:h-[18.9rem]">
        <div className="h-[12 rem] w-full  mini:w-[26rem]">
          ...
          <div className="mt-3 mini:h-[14 rem] w-full h-[6rem] mini:w-[25rem] mini:gap-x-6  ">
            ...
            Welcome to our luxurious cosmetic and parlor shop, where beauty meets indulgence!
             Step into a world of pampering and transformation, where we offer a selection of high-quality cosmetics and skincare products, as well as a range of beauty services to help you look and feel your best.
            </h1>
